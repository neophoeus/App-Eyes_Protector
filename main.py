...
class FloatingWidget:
    ...
    def _draw_eye(self, state):
        ...
        if state == "open":
            ...
            self.canvas.create_line(11, 18, 8, 14, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(15, 14, 13, 10, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(22, 10, 22, 6, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(29, 14, 31, 10, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(33, 18, 36, 14, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
        elif state == "closed":
            self.canvas.create_line(8, 19, 22, 29, 36, 19, smooth=True, fill="#f39c12", width=2, tags="icon_parts")
            self.canvas.create_line(11, 23, 8, 27, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(15, 26, 13, 30, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(22, 29, 22, 33, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(29, 26, 31, 30, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(33, 23, 36, 27, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
