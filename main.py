...
class FloatingWidget:
    ...
    def _draw_eye(self, state):
        ...
        if state == "open":
            ...
            # Open eye (contour curves up, eyelashes go up)
            self.canvas.create_line(12, 18, 10, 14, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(16, 15, 14, 11, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(22, 13, 22, 9, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(28, 15, 30, 11, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(32, 18, 34, 14, fill="#2c3e50", width=2, capstyle=tk.ROUND, tags="icon_parts")
        elif state == "closed":
            self.canvas.create_line(8, 19, 22, 29, 36, 19, smooth=True, fill="#f39c12", width=2, tags="icon_parts")
            # Closed eye (contour curves down, eyelashes go down)
            self.canvas.create_line(12, 23, 10, 27, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(16, 26, 14, 30, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(22, 27, 22, 31, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(28, 26, 30, 30, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
            self.canvas.create_line(32, 23, 34, 27, fill="#f39c12", width=2, capstyle=tk.ROUND, tags="icon_parts")
