...
class PlatformUtilsTests(unittest.TestCase):
    def test_is_fullscreen_or_busy_uses_notification_state(self):
        with mock.patch(
            ...
            with mock.patch(
                ...
                self.assertTrue(platform_utils.is_fullscreen_or_busy())

    def test_is_fullscreen_or_busy_detects_fullscreen_window_even_with_activity(self):
        with mock.patch(
            "eyes_protector.platform_utils._query_user_notification_state",
            return_value=None,
        ):
